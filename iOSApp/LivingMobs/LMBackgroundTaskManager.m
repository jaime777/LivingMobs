...
@interface LMBackgroundTaskManager()
@property (nonatomic, strong)NSMutableArray* bgTaskIdList;
@property (assign) UIBackgroundTaskIdentifier masterTaskId;
@end

@implementation LMBackgroundTaskManager

+(instancetype)sharedBackgroundTaskManager{
    static LMBackgroundTaskManager* sharedBGTaskManager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedBGTaskManager = [[LMBackgroundTaskManager alloc] init];
    });
